...
//GetResult(string stringifiedNumber) returns string windowTypeResponse

// Can uncomment these for simple testing in a CLI with 
string[] arguments = Environment.GetCommandLineArgs();
string stringResponse = OE.GetResult(arguments[2]);
...
public class OE
{
    public static string GetResult(string value)
    {
        ...
        string responseText = $"<a href=\"text://<font color={textColor}>OE data for <font color={valueColor}>{value}</font> skill";
